...
**Bloqueio no Windows 11:** as releases atuais não têm assinatura de código Authenticode. O manifesto Ed25519 verifica a atualização baixada pelo Lumen, mas não autentica o executável perante o Windows. O SmartScreen pode avisar e o Smart App Control ativo pode bloquear a execução (evento Code Integrity 3077), inclusive de ZIPs extraídos sem marca de download. Não desligue o Smart App Control para instalar o Lumen: essa mudança nas Configurações do Windows pode não ser reversível sem redefinir o sistema. Para distribuição compatível, o projeto precisa assinar executáveis e instaladores com um certificado de uma autoridade confiável; a assinatura gratuita para projetos open source está sob avaliação.
